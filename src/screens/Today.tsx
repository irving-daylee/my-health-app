    ...
    <>
      ...
      <Card title="Context">
        ...
        <p className="note" style={{ marginTop: 10 }}>
          ...
          tikken. Hij licht op als je gisteren voetbalde, ook als je vandaag weer speelt: bij twee
          dagen achter elkaar staan ze allebei aan en tellen hun effecten bij elkaar op. Deze dag
          telt apart mee in wat de app over je weegschaal leert: na een wedstrijd sta je eerst laag
